...
<html lang="en">
    <head>
        ...
        <title>Registering Correctly</title>
    ...
    <body>
        ...
        <p style="text-align: center; font-weight: bold; font-size: 40px; margin-top: 20px;">Registering Correctly</p>
        ...
        <div class="container">
            ...
            <p>Further to your Docket No: <span id="docketNoSpan"></span> dated <span id="dateSpan"></span>, we would inform you that the captioned meter was examined by us at site on <span id="examineDateSpan"></span> when it was found to be registered correctly the consumption being made through it. The reading noted on that date was <span id="readingSpan"></span> </p>
        ...
        <script>
            $(document).ready(function () {
                $("#dataForm").submit(function (event) {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            $("#readingSpan").text(response.reading);
                            $("#error").text("");
                        },
                ...
                $("#dataForm input[type='reset']").click(function () {
                    $("#dataForm")[0].reset();
                    $("#consumerNumberSpan, #consumerNumberSpan1, #nameSpan, #streetSpan, #citySpan, #stateNoSpan, #meterNumberSpan, #docketNoSpan, #dateSpan, #examineDateSpan, #readingSpan").text("");
                });
            });
        </script>
    </body>
